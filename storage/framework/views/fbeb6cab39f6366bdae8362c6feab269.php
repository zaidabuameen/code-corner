...
<body>
  ...
  <header class="topbar">
    <div class="wrap">
      <div class="brand">
        <img src="<?php echo e(asset('images/CODE CORNER LOGO1.jpg')); ?>" alt="Code Corner Logo" class="logo-img" loading="lazy" />
        <h1>Code Corner</h1>
      </div>
      <nav class="nav" aria-label="التنقل">
        <a href="<?php echo e(route('notes.index')); ?>"><i class="fa-solid fa-clipboard"></i><span>الملاحظات</span></a>
        <a href="<?php echo e(route('menu')); ?>"><i class="fa-solid fa-utensils"></i><span>المنيو</span></a>
  ...
  <div class="shell">
    ...
    <main class="content">
      ...
      <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $id = 'sec' . $i; ?>
        <section id="<?php echo e($id); ?>" class="section">
          <h2><i class="fa-solid fa-layer-group"></i> <?php echo e($item['title']); ?></h2>
          <div class="menu-grid">
            <article class="card">
              ...
              <div class="card-media">
                <img src="<?php echo e(asset('images/' . $item['img'])); ?>" alt="<?php echo e($item['title']); ?>" loading="lazy" />
                <div class="badge"><?php echo e($item['title']); ?></div>
              </div>
              <div class="card-body">
                <ul class="items">
      ...
      <section class="feedback">
        ...
        <a href="<?php echo e(route('notes.index')); ?>"><i class="fa-solid fa-comment-dots"></i> اضغط هنا لإبداء رأيك</a>
      </section>
