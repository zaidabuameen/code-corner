...
<body>
    <div class="logo-container">
        <img src="<?php echo e(asset('images/CODE CORNER LOGO1.jpg')); ?>" alt="Code Corner Logo" class="logo-img">
    </div>

    <nav>
        <div class="nav-container">
            <a href="<?php echo e(route('notes.index')); ?>"><i class="fas fa-notes"></i> الملاحظات</a>
            <a href="<?php echo e(route('menu')); ?>"><i class="fas fa-utensils"></i> المنيو</a>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="menu-grid">
            ...
            [
                        ...
                        "img" => "IMG_1723.PNG", 
                        "items" => [
                            ["name" => "تشيز كيك توت", "price" => "2.00 JD"],
                            ["name" => "تشيز أوريو", "price" => "2.00 JD"],
                            ["name" => "تشيز لوتس", "price" => "2.00 JD"],
                            ["name" => "هبة البستاشيو", "price" => "2.00 JD"],
                        ]
                    ],
                    [
                        "title" => "البوظة 🍦",
...
[
    ...
    [
            ...
            <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="menu-card <?php if(isset($item['special'])): ?> special-card <?php endif; ?>">
                    <div class="card-header">
                        <img src="<?php echo e(asset('images/' . $item['img'])); ?>" alt="<?php echo e($item['title']); ?>" class="card-img">
                        <div class="card-category"><?php echo e($item['title']); ?></div>
                    </div>
                    <div class="card-body">
                    
                        </h3>
                        <ul class="menu-items">
                            <?php $__currentLoopData = $item['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="menu-item">
                                    <span class="item-name"><?php echo e($menuItem['name']); ?></span>
                                    <span class="item-price"><?php echo e($menuItem['price']); ?></span>
                                </li>
        ...
        <div class="feedback-section">
            ...
            <a href="<?php echo e(route('notes.index')); ?>" class="feedback-btn">
...
</html><?php /**PATH C:\Users\wmutl\notes-app\resources\views/menu.blade.php ENDPATH**/ ?>