...
<div class="container">
    ...
    <?php
        $menu = [
            ...
            ["title" => "٧ أنواع بوظة 🍦", "img" => "Various_coloured_ice_cream_shutterstock_1678666684.jpg", "items" => [
                ...
                ["name" => "فانيلا", "price" => "1.2 JD"],
                ["name" => "فراولة", "price" => "1.3 JD"],
                ["name" => "بستاشيو", "price" => "1.6 JD"],
                ["name" => "مانجو", "price" => "1.4 JD"],
                ["name" => "كيت كات", "price" => "1.8 JD"],
                ["name" => "أوريو", "price" => "1.8 JD"]
            ]],
            ...
            ["title" => "العصائر 🥤", "img" => "blender.jpg", "items" => [
                ...
                ["name" => "ليمون", "price" => "1.3 JD"],
                ["name" => "برتقال", "price" => "1.4 JD"]
            ]],
            ...
            ["title" => "كوكتيلات بوظة 🍨", "img" => "milkshakes.jpg", "items" => [
                ["name" => "ميلك شيك فانيلا", "price" => "2.5 JD"],
                ["name" => "ميلك شيك شوكولاتة", "price" => "2.5 JD"],
                ["name" => "ميلك شيك أوريو", "price" => "2.7 JD"]
            ]],
        ...
        <div class="section">
            <div class="section-content">
                <div class="section-text">
                    ...
                    <ul>
                        <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($item['name']); ?> <span class="price"><?php echo e($item['price']); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <?php if($section['title'] === 'Code Corner Mixology ✨'): ?>
                ...
                <div class="section-img">
                    <img src="<?php echo e(asset('images/' . $section['img'])); ?>" alt="<?php echo e($section['title']); ?>">
                </div>
            </div>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="feedback-section">
        ...
        <div class="feedback-content">
            ...
            <a href="<?php echo e(route('notes.index')); ?>" class="feedback-link">اضغطوا هنا لإبداء رأيكم</a>
